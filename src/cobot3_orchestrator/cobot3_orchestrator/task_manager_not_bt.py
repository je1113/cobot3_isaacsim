...
종류 하나만 받는다.
    ...
    ros2 run cobot3_orchestrator task_manager_not_bt
...
# ══════════════════════════════════════════════════════════════════════════
#  이 파일은 행동트리로 바꾸기 전의 task_manager.py 를 그대로 보존한 사본이다.
#  원본: eebbf03 의 cobot3_orchestrator/task_manager.py (511줄).
#
#  지금 쓰는 것은 옆의 task_manager.py (행동트리 판) 다. 이 파일은 비교·대조와
#  되돌릴 자리를 남겨두기 위한 것이다. 노드 이름이 둘 다 "task_manager" 라
#  동시에 띄울 수는 없다.
#
#  flake8: noqa — 원본을 한 글자도 고치지 않으려고 스타일 검사를 끈다. 이 줄을
#  지우면 ament_flake8 이 위반 29건(E261 12 · E265 6 · W291 5 · E262 4 · W293 1
#  · E501 1)을 낸다 — 전부 원본이 갖고 있던 것이고 새로 생긴 게 아니다.
# ══════════════════════════════════════════════════════════════════════════
# flake8: noqa
